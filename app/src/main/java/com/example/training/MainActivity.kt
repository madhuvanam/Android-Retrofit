...
import com.example.training.detail.DetailActivity
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.posts.observe( this, Observer {  posts ->
            ...
            binding.refreshPosts.smoothScrollToPosition(numElements)
        })
        ...
        blogPostAdapter = BlogPostAdapter( this, blogPosts, object : BlogPostAdapter.ItemClickListener {
            override fun onItemClick(post: Post) {
                // navigate to new activity opening the selected post
        ...
        binding.refreshPosts.adapter = blogPostAdapter
        binding.refreshPosts.layoutManager = LinearLayoutManager( this)
